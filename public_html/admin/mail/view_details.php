...
<?php     if(!isset($_SESSION['loginad']) || $_SESSION['loginad'] !== true){
                    ...
                    <div class="card-body">
                        ...
                        ?>>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" readonly class="form-control" name="mailid" id="id" value="<?php if($result) echo $result['id']?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="name" class="col-sm-4 col-form-label">Name</label>
                                    <div class="col-sm-8">
                                        <input type="text" readonly class="form-control" id="name" value="<?php if($result) echo $result['name']; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email" class="col-sm-4 col-form-label">Email</label>
                                    <div class="col-sm-8">
                                        <input type="email" readonly class="form-control" id="email" value="<?php if($result) echo $result['email']; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="current" class="col-sm-4 col-form-label">Time received</label>
                                    <div class="col-sm-8">
                                        <input type="datetime" readonly class="form-control" id="current" value="<?php if($result) echo $result['current']; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="contact" class="col-sm-4 col-form-label">Contact</label>
                                    <div class="col-sm-8">
                                        <input type="text" readonly class="form-control" id="contact" value="<?php if($result) echo $result['contact']; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
