...
<nav class="navbar navbar-expand-lg navbar-light bg-light" id="navbar">
    ...
    <div class="content-wrap">
        <div class="container login">
            <div class="container dashboard" id = "deleteStaff" style="height:500px">
        ...
        <div class="modal fade" id="deleteMultiple" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <form method="post"  action="deleteMultiples.php">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="fName" placeholder="First Name" pattern="[A-Za-z ]{1,30}">
                </div>
                <div class="form-group">
                    <label for="lName">Last Name</label>
                    <input type="text" class="form-control" name="lName" placeholder="Last Name" pattern="[A-Za-z]{1,30}">
                </div>
                <div class="form-group">
            ...
            <div class="modal-body">
                <form method="post"  action="deleteSpecific.php">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="ID" placeholder="ID" required pattern="[A-Za-z0-9]{10}">
                    </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" style="margin-bottom: 0px">Close</button>
