    ...
    <div class="login content-wrap">
        ...
        <div class="login-box">
            <ul class="nav nav-tabs nav-justified" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link active" id="maintenanceTab" data-bs-toggle="tab" data-bs-target="#maintenance-nav" type="button" role="tab" aria-controls="maintenance-nav" aria-selected="true">Up For Maintenance</a>
                </li>
                <li class="nav-item">
