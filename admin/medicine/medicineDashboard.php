...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="container dashboard" id = "med-dashboard">
            <div class="row">
                <div class="col">
                    <a href="findMed.php" class = "btn btn-primary"><i class="fa fa-pills"></i> <br>Find Medicines</a>
                </div>
                <div class="col">
                    <a href="addMed.php" class="btn btn-primary"><i class="fas fa-plus"></i> <br>Add Medicines</a>
                </div>
                <div class="col">
                    <a href="" class="btn btn-primary"><i class="fas fa-plus"></i> <br>Delete Medicines</a>
                </div>
            </div>
            <div class="row">
                <div class="col">
